...
abstract class BaseOverlayManager(
    ...
    /**
     * Get the current zoom category for the map
     */
    protected fun getCurrentZoomCategory(): com.madanala.tern.utils.ZoomCategory {
        val zoom = mapView?.zoomLevelDouble ?: 12.0
        return com.madanala.tern.utils.ZoomCategory.fromZoom(zoom)
    }
    ...
    protected fun calculateAdaptiveQueryRadius(zoom: Double): Double {
        return com.madanala.tern.utils.ZoomCategory.fromZoom(zoom).queryRadiusKm
    }
