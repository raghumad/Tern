...
import com.ternparagliding.redux.OverlayState
...
class RouteDetailPanelWeatherTest : com.ternparagliding.utils.BddTest() {
        ...
        scenario("Waypoint Weather Display in Detail Panel") {
            story("As a pilot reviewing my route, I want to see the specific weather forecast for each waypoint so I can anticipate wind conditions at different points along my flight path.") {
                ...
                `when`("the pilot opens the Route Detail Panel for this flight task") {
                    ...
                    testStore.dispatch(com.ternparagliding.redux.MapAction.AddRoute(testRoute))
                    testStore.dispatch(com.ternparagliding.redux.MapAction.SelectRoute(testRoute.id))
                    testStore.dispatch(com.ternparagliding.redux.WeatherActions.RouteWeatherFetched(testRoute.id, mapOf("wp_1" to forecastWp1)))
